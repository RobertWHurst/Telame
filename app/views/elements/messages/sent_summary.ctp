...
<div class="message clearfix">
	<div class="avatar">
<?php
		$image_url = array('controller' => 'media', 'action' => 'avatar', $message['User']['id']);
		$url = array('controller' => 'users', 'action' => 'profile', $message['User']['slug']);
...
<?php
		...
		$link_content .= "<h2 class=\"to\">{$message['User']['Profile']['full_name']}</h2>";
