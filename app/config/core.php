 ...
 *
 */
 // This is custom, most of the settings below regarding sessions won't do anything any more
	Configure::write('Session.save', 'telame_sessions');
 ...
 */
	Configure::write('Session.timeout', '1440'); // 24 hours
