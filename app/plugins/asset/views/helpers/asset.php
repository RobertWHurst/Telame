		...
		foreach($this->assets as $asset) {
			...
			switch($asset['type']) {
				case 'js':
					...
					$scripts_for_layout[] = $this->Javascript->link('http://' . Configure::read('StaticDomain') . '/' . $this->cachePaths['js'] . '/' . $processed);
					break;
				case 'css':
					$processed = $this->__process($asset['type'], $asset['assets']);
					$scripts_for_layout[] = $this->Html->css('http://' . Configure::read('StaticDomain') . '/' . $this->cachePaths['css'] . '/' . $processed . '.css');
					break;				
				default:
